...
public interface ProductRepository extends JpaRepository<Product, Integer> {
    ...
    List<Product> findByTitleAndCategoryAndPriceBetweenOrderByPriceAsc(String title, float from, float to, int category);
    ...
    List<Product> findByTitleAndCategoryAndPriceBetweenOrderByPriceDesc(String title, float from, float to, int category);
}